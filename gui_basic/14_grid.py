...
# 맨 윗줄
btn_f16 = Button(root, text="F16", width=5, height=2)   # padx=10, pady=10를 쓸경우 글자 수에따라 사이즈가 달라질 수 있음
...
btn_enter.grid(row=4, column=3, rowspan=2, sticky=N+E+W+S, padx=3, pady=3)  # rowspan = 2; row 2개를 합치겠다(현재 위치로부터 아랫줄로)
